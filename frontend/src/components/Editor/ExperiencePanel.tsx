...
const ExperienceCard: React.FC<ExperienceCardProps> = ({ sectionId, entry, index }) => {
  ...
  return (
    ...
    >
      {/* Card Header: Drag handle, Title/Company summary, Delete action */}
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-[13px] font-semibold text-[var(--ink)] truncate">
              {entry.title || `${t("editor.experience.entryDefaultTitle")} #${index + 1}`}
            </span>
            {entry.subtitle && (
      ...
      {/* Row 1: Position (Title) & Company (Subtitle) */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        <div>
          <div className="flex items-center justify-between min-h-[24px] mb-1.5">
            <label className="field-label m-0 truncate">{t("editor.experience.company")}</label>
          </div>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <div>
          <div className="flex items-center justify-between min-h-[24px] mb-1.5">
            <label className="field-label m-0 truncate">{t("editor.experience.location")}</label>
          </div>
          <input
            type="text"
        ...
        <div>
          <div className="flex items-center justify-between min-h-[24px] mb-1.5">
            <div className="flex items-center gap-1.5 min-w-0">
              ...
              <label className="field-label m-0 truncate">{t("editor.experience.link")}</label>
            </div>
            {entry.meta?.link && (
              <a
          ...
          <input
            ...
            placeholder={t("editor.experience.linkPlaceholder")}
            className="native-input"
          />
        </div>
      </div>
      ...
      <div>
        <div className="flex items-center justify-between min-h-[24px] mb-1.5">
          <label className="field-label m-0 truncate">{t("editor.experience.dates")}</label>
